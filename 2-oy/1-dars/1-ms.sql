...
\c sqldatabase;
drop table students ; 
Create table Students(id Serial PRIMARY KEY,First_name varchar not null,Last_name varchar,Age int,Gender varchar,Score int,Addresss varchar,Email varchar,Phone_number varchar,Date_of_birth date);
\d students;
